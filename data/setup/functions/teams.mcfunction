...
team add RadSlimes
team modify RadSlimes prefix [{"text": "[","color": "white"},{"text": "☢","color":"green"},{"text": "] ","color": "white"}]
...
team add BoomSlimes
team modify BoomSlimes prefix [{"text": "[","color": "white"},{"text": "💥","color":"red"},{"text": "] ","color": "white"}]
...
team modify AnglerSlimes prefix [{"text": "[","color": "white"},{"text": "🐠","color":"blue"},{"text": "] ","color": "white"}]
...
team modify HoneySlimes prefix [{"text": "[","color": "white"},{"text": "🍯","color":"yellow"},{"text": "] ","color": "white"}]
