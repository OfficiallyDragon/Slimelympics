...
give @a[team=AnglerSlimes] honey_block{CanPlaceOn:["minecraft:lily_pad","minecraft:honey_block"],display:{Name:'{"text":"Honey Shield","color":"yellow","bold":true,"italic":false}'},Enchantments:[{}]} 10
give @a[team=HoneySlimes] honey_block{CanPlaceOn:["minecraft:lily_pad","minecraft:honey_block"],display:{Name:'{"text":"Honey Shield","color":"yellow","bold":true,"italic":false}'},Enchantments:[{}]} 10
