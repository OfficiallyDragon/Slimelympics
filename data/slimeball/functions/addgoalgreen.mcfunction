...
execute if score @e[type=armor_stand,name=TotalGreenGoals,limit=1] TotalRadSlimeGoals matches 15 run scoreboard players set @e[type=armor_stand,name=TotalGreenGoalCounter,limit=1] TotalRadSlimeGoals 0
