...
execute if score @e[type=armor_stand,name=TotalRedGoals,limit=1] TotalBoomSlimeGoals matches 15 run scoreboard players set @e[type=armor_stand,name=TotalRedGoalCounter,limit=1] TotalBoomSlimeGoals 0
