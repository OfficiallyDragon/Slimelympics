...
execute if score @e[type=armor_stand,name=TotalBlueGoalCounter,limit=1] TotalAnglerSlimeGoals matches 5 run setblock 3727 77 3172 redstone_block
execute if score @e[type=armor_stand,name=TotalBlueGoalCounter,limit=1] TotalAnglerSlimeGoals matches 10 run setblock 3727 77 3171 redstone_block
execute if score @e[type=armor_stand,name=TotalBlueGoalCounter,limit=1] TotalAnglerSlimeGoals matches 15 run setblock 3727 77 3170 redstone_block
execute if score @e[type=armor_stand,name=TotalBlueGoalCounter,limit=1] TotalAnglerSlimeGoals matches 15 run schedule function slimeball:resettotalgoals 5s
execute if score @e[type=armor_stand,name=TotalBlueGoalCounter,limit=1] TotalAnglerSlimeGoals matches 15 run scoreboard players set @e[type=armor_stand,name=TotalBlueGoalCounter,limit=1] TotalAnglerSlimeGoals 0
